...
import NavContext, { NavbarContxt } from '../../context/NavContext'

const FullScreenNav = () => {
    const fullNavLinksRef = useRef(null)
    const fullScreenRef = useRef(null)

    const [navOpen, setNavOpen] = useContext(NavbarContxt)
            ...
            <div ref={fullNavLinksRef} className='relative'>
                <div className="navlink flex w-full justify-between lg:p-3 p-2 items-start">
                    ...
                    <div onClick={() => {
                        ...
                        <div className='lg:h-42 h-28 lg:w-0.7 w-0.5 -rotate-45 origin-top absolute bg-[#D3FD50]'></div>
                        <div className='lg:h-42 h-28 lg:w-0.7 w-0.5 right-0 rotate-45 origin-top absolute bg-[#D3FD50]'></div>
