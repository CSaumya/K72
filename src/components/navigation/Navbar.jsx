...
import { NavbarColorContext, NavbarContxt } from '../../context/NavContext'
...
const Navbar = () => {
    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            <Link to='/' className='lg:p-5 p-2 cursor-pointer'>
            ...
            <div onClick={()=>{
                ...
                <div className='relative h-full lg:px-12 px-8 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
                    <div className="lg:w-18 w-16 h-0.5 bg-white"></div>
